...
% 计算种群多样性（平均距离）
D1(epoch, t) = mean(distances);
a1(q, t) = 2 * (1 - t / maxIter); % a decreases linearly fron 2 to 0
for i = 1:pop
...
A1=2*a1(q, t)*r1-a1(q, t); % Equation (3.3)
...
A2=2*a1(q, t)*r1-a1(q, t); % Equation (3.3)
...
A3=2*a1(q, t)*r1-a1(q, t); % Equation (3.3)
...
% 计算种群多样性（平均距离）
D2(epoch, t) = mean(distances);

eta = 0.1;
b = 0.1;
if D2(epoch, t) > eta
    a2(q, t) = 2 * (1 - t / maxIter);
    T = t;
    a_mid = a2(q, t);
else
    a2(q, t) = a_mid * exp(-b * (t - T));
end
...
A1=2*a2(q, t)*r1-a2(q, t); % Equation (3.3)
C1=2*r2; % Equation (3.4)
...
A2=2*a2(q, t)*r1-a2(q, t); % Equation (3.3)
C2=2*r2; % Equation (3.4)
...
A3=2*a2(q, t)*r1-a2(q, t); % Equation (3.3)
C3=2*r2; % Equation (3.4)
...
% 计算种群多样性（平均距离）
D3(epoch, t) = mean(distances);

% eta = 0.1;
b = 0.5;
if D3(epoch, t) > eta
    a3(q, t) = 2 * (1 - t / maxIter);
    T = t;
    a_mid = a3(q, t);
else
    a3(q, t) = a_mid * exp(-b * (t - T));
end
...
A1=2*a3(q, t)*r1-a3(q, t); % Equation (3.3)
C1=2*r2; % Equation (3.4)
...
A2=2*a3(q, t)*r1-a3(q, t); % Equation (3.3)
C2=2*r2; % Equation (3.4)
...
A3=2*a3(q, t)*r1-a3(q, t); % Equation (3.3)
C3=2*r2; % Equation (3.4)
...
% 计算种群多样性（平均距离）
D4(epoch, t) = mean(distances);

b = 1;
if D4(epoch, t) > eta
    a4(q, t) = 2 * (1 - t / maxIter);
    T = t;
    a_mid = a4(q, t);
else
    a4(q, t) = a_mid * exp(-b * (t - T));
end
...
A1=2*a4(q, t)*r1-a4(q, t); % Equation (3.3)
C1=2*r2; % Equation (3.4)
...
A2=2*a4(q, t)*r1-a4(q, t); % Equation (3.3)
C2=2*r2; % Equation (3.4)
...
A3=2*a4(q, t)*r1-a4(q, t); % Equation (3.3)
C3=2*r2; % Equation (3.4)
...
legend('{\fontname{Times New Roman}Standard} {\fontname{Times New Roman}GWO}','{\fontname{Times New Roman}Improved} {\fontname{Times New Roman}GWO (\sigma=0.1)}','{\fontname{Times New Roman}Improved} {\fontname{Times New Roman}GWO (\sigma=0.5)}','{\fontname{Times New Roman}Improved} {\fontname{Times New Roman}GWO (\sigma=1)}',...%    
...
%% 
figure(2);
plot(Aa1,'LineWidth',1.5);
hold on;
plot(Aa2,'LineWidth',1.5);
hold on;
plot(Aa3,'LineWidth',1.5);
hold on;
plot(Aa4,'LineWidth',1.5);
% 获取当前轴
ax = gca;
% 设置 X 和 Y 轴的刻度标签格式
ax.XAxis.Exponent = 0;
...
ylabel('{\fontname{Times New Roman}Parameter a}');
set(gca, 'FontName', 'Times New Roman', 'FontSize', 12);
legend('{\fontname{Times New Roman}Standard} {\fontname{Times New Roman}GWO}','{\fontname{Times New Roman}Improved} {\fontname{Times New Roman}GWO (\sigma=0.1)}','{\fontname{Times New Roman}Improved} {\fontname{Times New Roman}GWO (\sigma=0.5)}','{\fontname{Times New Roman}Improved} {\fontname{Times New Roman}GWO (\sigma=1)}',...%    
     'NumColumns',1,'FontSize', 12, 'Location', 'northeast');
grid on
...
figure(3);
plot(AD1,'LineWidth',1.5);
hold on;
plot(AD2,'LineWidth',1.5);
hold on;
plot(AD3,'LineWidth',1.5);
hold on;
plot(AD4,'LineWidth',1.5);
xlabel('{\fontname{Times New Roman}Iteration Number}');
ylabel('{\fontname{Times New Roman}Parameter D}');
set(gca, 'FontName', 'Times New Roman', 'FontSize', 12);
legend('{\fontname{Times New Roman}Standard} {\fontname{Times New Roman}GWO}','{\fontname{Times New Roman}Improved} {\fontname{Times New Roman}GWO (\sigma=0.1)}','{\fontname{Times New Roman}Improved} {\fontname{Times New Roman}GWO (\sigma=0.5)}','{\fontname{Times New Roman}Improved} {\fontname{Times New Roman}GWO (\sigma=1)}',...%    
     'NumColumns',1,'FontSize', 12, 'Location', 'northeast');
grid on
