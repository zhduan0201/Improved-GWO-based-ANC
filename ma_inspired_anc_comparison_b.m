...
% IterCurve2(t) = IterCurve2(t) + mean(fitness2);
%% 更新
% Abandonment Counter
C = zeros(pop, 1);
%% 雇佣蜂
...
% IterCurve2(t)=IterCurve2(t) + mean(fitness4);
%% 更新
